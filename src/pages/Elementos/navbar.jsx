...
function Navbar() {
    ...
    return (
        <div>
            <nav id="navbar" className={'navbar navbar-expand-lg'} style={{ padding: '20px', color: 'white' }}>
                    ...
                    <div className="  collapse navbar-collapse  " id="navbarNav">
                        ...
                        <ul className="navbar-nav flex-row flex-wrap ms-md-auto">
                            ...
                            <button className="btn-cssbuttons">
                                ...
                                <span style={{ color: "white" }}>Contactame!</span><span>
                                ...
                                <ul>
                                    <li>
                                        <a href="https://github.com/GnesisVSS">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" className="bi bi-github icon"
                                                viewBox="0 0 16 16">
                                                <path
