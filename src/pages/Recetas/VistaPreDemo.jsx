...
const VistaPreDemo = () => {
    ...
    return (
        <section id='recetas' style={{ backgroundColor: '#EDE6F1', color: '#162E36', minHeight: '100vh' }}>
            <motion.div
                ref={ref}
                variants={boxVariant}
                initial="hidden"
            ...
            >
                <div className='py-5'>
                    <div className="container col-sm-12 py-2 mx-auto">
                        ...
                        <div className="row justify-content-center">
                            ...
                            <div className="col-sm-8 col-md-6 p-5 align-self-center">
                                ...
                                <div className="col" style={{ lineHeight: '27px' }}>
                                    <strong><h1 style={{ textAlign: 'left', color: '#162E36' }} className='h1Proyectos'>Pagina web de Recetas</h1></strong>
                                    <div className='py-4'>
                                        <p style={estilo2}>
                        ...
                        <Table aria-label="basic table"  sx={{ '& thead th:nth-child(1)': { width: '40%' } }}>
                            <tbody>
                                <tr>
                                    <td> <strong>Lenguaje de Programación</strong></td>
                                    <td><IconBrandJavascript width='32px' height='32px' style={{ color: '#ffd630', margin: '18px', backgroundColor: 'white', borderRadius: '15px' }} /></td>
                                    <td>JavaScript</td>
                                </tr>
                                <tr>
                                    <td> <strong>Framework</strong> </td>
                                    <td><IconBrandReact width='32px' height='32px' style={{ color: '#61DBFB', margin: '18px', backgroundColor: 'white', borderRadius: '15px' }} /></td>
                                    <td>ReactJS</td>
                                </tr>
                                <tr>
                                    ...
                                    <td>MySql con PlanetScale</td>
                                </tr>
                                <tr>
                                    <td> <strong>Complementos</strong> </td>
                                    <td><IconBrandGit width='32px' height='32px' style={{ color: '#f96926', margin: '18px', backgroundColor: 'white', borderRadius: '15px' }} /></td>
                                    <td>Git</td>
                                </tr>
                                <tr>
                                    <td> <strong></strong> </td>
                                    <td><IconBrandHtml5 width='32px' height='32px' style={{ color: '#f96926', margin: '18px', backgroundColor: 'white', borderRadius: '15px' }} /></td>
                                    <td>HTML</td>
                                </tr>
                                <tr>
                                    <td> <strong></strong> </td>
                                    <td><IconBrandCss3 width='32px' height='32px' style={{ color: '#61DBFB', margin: '18px', backgroundColor: 'white', borderRadius: '15px' }} /></td>
                                    <td>CSS</td>
                                </tr>
                            </tbody>
                        </Table>
